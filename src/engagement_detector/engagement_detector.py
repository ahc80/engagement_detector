...
class EngagementDetector:
    ...
    def predict(self, frames_seq):
        ...
        # Resize frames to 224x224 and convert to NumPy array
        resized_frames = [np.array(Image.fromarray(frame).resize((224, 224))) for frame in frames_seq]

        # Preprocess with keras_applications' preprocess_input
